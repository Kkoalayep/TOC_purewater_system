...
typedef struct
{
	...
	lv_obj_t *screen_oxidize_state_lable;
	lv_obj_t *screen_oxidize_sw;
	...
	lv_obj_t *screen_start_conductivity_lable;
	lv_obj_t *screen_end_conductivity_lable;
	lv_obj_t *screen_toc_lable;
	lv_obj_t *screen_label_16;
	lv_obj_t *screen_label_17;
	lv_obj_t *screen_label_18;
	lv_obj_t *screen_motor_sw;
	lv_obj_t *screen_motor_state_lable;
	lv_obj_t *screen_label_19;
	lv_obj_t *screen_light_sw;
	lv_obj_t *screen_light_state_lable;
	lv_obj_t *screen_label_21;
	lv_obj_t *screen_svo_sw;
	lv_obj_t *screen_clear_state_lable;
	lv_obj_t *screen_label_23;
	lv_obj_t *screen_clear_sw;
	lv_obj_t *screen_svo_state_lable;
	lv_obj_t *screen_label_25;
	lv_obj_t *screen_svt_sw;
	lv_obj_t *screen_svt_state_lable;
...
LV_FONT_DECLARE(lv_font_simfang_24)
