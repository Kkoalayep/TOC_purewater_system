...
/** 
  ...
  */
#define SDIO_TRANSFER_CLK_DIV            ((u8)0x04) 
...
extern SD_Error SD_ReadBlock(u8 *readbuff, long long  ReadAddr, u16 BlockSize);
extern SD_Error SD_ReadMultiBlocks(u8 *readbuff, long long  ReadAddr, u16 BlockSize, u32 NumberOfBlocks);
extern SD_Error SD_WriteBlock(u8 *writebuff, long long WriteAddr, u16 BlockSize);
extern SD_Error SD_WriteMultiBlocks(u8 *writebuff, long long WriteAddr, u16 BlockSize, u32 NumberOfBlocks);
